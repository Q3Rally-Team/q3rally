...
static void Controls_DrawKeyBinding( void *self )
{
	...
	if (c)
	{
		...
		else
		{
			...
			UI_DrawString(SCREEN_WIDTH * 0.55, SCREEN_HEIGHT * 0.78, "Press ENTER or CLICK to change", UI_SMALLFONT|UI_CENTER, colorWhite );
			UI_DrawString(SCREEN_WIDTH * 0.55, SCREEN_HEIGHT * 0.82, "Press BACKSPACE to clear", UI_SMALLFONT|UI_CENTER, colorWhite );
		}
	}
	else
	{
