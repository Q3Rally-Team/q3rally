...
TEST_BINARY = REPO_ROOT / "tests" / "ai_dmnet_route_fallback_test"

COMPILE_ARGS = [
    "gcc",
    str(REPO_ROOT / "tests" / "ai_dmnet_route_fallback_test.c"),
...
def test_ai_dmnet_route_fallback_behavior() -> None:
